...
export default function ServiceDetail() {
  ...
  return (
    <div ref={containerRef} className="w-full">
      {/* Hero Section */}
      <section className="relative py-10 sm:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 scroll-animate scroll-delay-100 bg-cover bg-center bg-fixed" style={{ backgroundImage: `url('https://images.pexels.com/photos/8085938/pexels-photo-8085938.jpeg')` }}>
        {/* Background Overlay */}
