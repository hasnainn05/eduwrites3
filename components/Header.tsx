              ...
              <div className="absolute left-0 mt-0 bg-white border border-border rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 shadow-lg min-w-max">
                <div className="grid grid-cols-2 gap-0">
                  ...
                  <div className="px-4 py-3 border-r border-border">
                    <h3 className="text-xs lg:text-sm font-bold text-primary mb-2 uppercase tracking-wider">
                    ...
                    {serviceGroups.writing.services.map((service) => (
                      <Link
                        ...
                        className="block px-3 py-1.5 text-xs text-foreground hover:text-primary hover:bg-primary/5 transition-colors whitespace-nowrap"
                      >
                        {service.description}
                      </Link>
                    ))}
